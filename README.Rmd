...
# Miscellaneous notes
    ...
    * For the section on methodology where we put all the code, the LW paper has four codes that 
      ...
      I'm working on just replicating the US data first, but I'm struggling to get the getFRED() function
      to run. I think its a directory issue but the only place I can see a directory is when it wants to put
      the data in the folder: Data.
                
      In terms of the other data, do I put all the data in one file? Or must they be in separate sub-folders
      for each country?
