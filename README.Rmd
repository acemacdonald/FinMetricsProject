...
# Miscellaneous notes
    ...
    Prepared the EU data in a new script called  prepare.attempt.ea
    Up until line 103, where I got this response:
    
    Path 'X13' specified but does not exists.
    Error in checkX13(fail = TRUE, fullcheck = FALSE, htmlcheck = FALSE) : 
     Process terminated
     
    I understand its from line 15 but I dont know how to fix it.
    
    27/12
    Worked on the UK prep file - prepare.attempt.uk
    WOrked up until about line 63ish where my date format doesn't seem to hold
    when trying to specifiy bank.rate.data
