...
# For the section on methodology where we put all the code, the LW paper has      four codes that 
      prepare the data for each country. I'm not sure how to enter these into     them so they can all
      run simultaneously. The codes are:
                   -prepare.rstar.data.XX.R    ,  where XX = (ca, ea, uk, us)
      
     I fixed the issue with regards to the source function, but I remember
     you said I should rather make it a function? 
    
    In line in the prepare.rstar.data.uk.R script, I get the response
    "Error in read.table(gdp.file, skip = 6, header = FALSE, sep = ",", stringsAsFactors = FALSE) : 
  'file' must be a character string or connection"
  
  And this happens for all 3 variables, am I saving the data incorrectly?
